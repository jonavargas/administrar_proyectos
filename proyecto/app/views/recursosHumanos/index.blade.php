<?php
    if (Auth::check()) {
?> 
        <h2 class="titulos"><strong>Recurso Humano</strong></h2>        
        <div class="create">{{link_to("recursosHumanos/create", 'Crear', $attributes = array('class' => 'btn btn-primary'), $secure = null);}}</div>
<?php
    }
?> 
